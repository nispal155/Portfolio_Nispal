export const PORTFOLIO_DATA = {
  personal: {
    ...
    socials: {
      ...
      github: "https://github.com/nispal155",
      facebook: "https://www.facebook.com/nispal15",
      instagram: "https://www.instagram.com/nispalbhattaraiofficial/"
    }
  },
  skills: {
    frontend: [
  ...
  experience: [
    {
      ...
      points: [
        "Assisted in conducting the Basic Computer Operator course by providing training and guidance to students on fundamental computer skills and software usage.",
        "Developed strong communication, teamwork, and technical problem-solving abilities.",
        "Gained professional experience in the vocational training and government sector environment."
      ]
    },
    {
      role: "Front-End Developer Intern",
      company: "Midas Health Service",
      location: "Kathmandu, Nepal",
      period: "06/2025 – 09/2025",
      points: [
        "Worked as a Front-End Developer Intern in the IT & Innovation Department, assisting in the design and development of responsive web applications using HTML, CSS, JavaScript, React, and modern UI technologies.",
        "Collaborated with designers and developers to build reusable UI components.",
        "Improved user experience, fixed interface issues, and optimized application performance."
      ]
    }
  ],
  education: [
    {
      ...
      institution: "Itahari International College, Dulari",
      year: "2026"
    }
  ]
}
