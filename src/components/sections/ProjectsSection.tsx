  ...
  return (
    <SectionWrapper id="projects" className="bg-background">
      <div className="flex flex-col gap-12">
        ...
        >
          {PORTFOLIO_DATA.projects.slice(3).map((project, idx) => (
        ...
        <div className="flex flex-col items-center text-center gap-4 mt-16">
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight">Recent Projects</h2>
          <p className="text-muted-foreground max-w-2xl">
            My most recent full-stack builds, featuring advanced integrations and modern UI patterns.
          </p>
        </div>
